...
onMounted(async () => {
  await importDatabaseFromServer([
    "https://raw.githubusercontent.com/AmirAlimardanii/SQLite/refs/heads/feat/seperate-file/data_fixed_encrypted.txt",
  ]);
  ...
  await updateData(result.updateData.concat(result.createData));
